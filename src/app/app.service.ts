...
export class AppService {
  ...
  public getChat(receiverid, skip): Observable<any> {
    ...
    return this.http.get(`${this.url}/api/v1/chat/getGroupChat?chatRoomId=${receiverid}&skip=${skip}}`)
  ...
  public getAllGroups(): Observable<any> {
    ...
    return this.http.get(`${this.url}/api/v1/chatRoom/getAllChatRooms`);
